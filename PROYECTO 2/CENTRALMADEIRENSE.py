from mod_json import create_json
from mod_json import create_txt
from mod_json import save_from_json
from mod_json import append_to_txt
from mod_json import read_from_json
...
presione 2 para volver: '''))
        ...
        if not inventario:
            ...
            save_from_json(inventario,"inventario.json")
...
Indique la opción a tomar:  """))
            ...
            if opcion2 == 1:
                if not inventario:
                    ...
                    print("PRODUCTO                    PRECIO")
                    read_from_json("inventario.json")
                    for producto in inventario:
                        print(f"{producto['Producto']}                            {producto['Precio']}$")
...
factura = total_pagar
create_txt("factura.txt")
append_to_txt(factura,"factura.txt")
create_json("inventario.json")
save_from_json(inventario,"inventario.json")